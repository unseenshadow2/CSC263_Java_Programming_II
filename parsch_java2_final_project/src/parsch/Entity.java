...
public abstract class Entity
{
    ...
    public void Attack(Battle battle)
    {
        ...
        Game.eventsPrintln(this + " attempts to attack " + other);
        ...
        {
            Game.eventsPrintln(this + " has failed to hit " + other);
        }
    }

    public void Defend(Battle battle)
    {
        Game.eventsPrintln(this + " takes a defensive stance.");
        isDefending = true;
    }
    ...
    public void TakeDamage(int damage, int toHit, Entity attacker)
    {
        ...
        else
        {
            ...
            if (defendRoll >= toHit)
            {
                ...
                health -= actualDamage;
                Game.eventsPrintln(this + " negated " + (baseDefense + weapon.getDefense()) +
